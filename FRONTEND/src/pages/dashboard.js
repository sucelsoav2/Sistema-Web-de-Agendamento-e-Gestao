document.addEventListener("DOMContentLoaded", () => {
  ...
  const notificationStateLabel = document.getElementById(
  ...
  const defaultReminders = [
    {
      ...
      time: "09:30",
      notes: "Enviar link da reunião",
      status: "Ativo",
    },
    {
      id: "reminder-2",
      title: "Verificar agenda do dia",
      time: "08:00",
      notes: "Revisar compromissos",
      status: "Pendente",
    },
    {
      id: "reminder-3",
      title: "Confirmação de espaço",
      time: "10:00",
      notes: "Confirmar disponibilidade",
      status: "Concluído",
    },
  ];
  ...
  const renderSpaces = () => {
    ...
    spacesTableBody.querySelectorAll(".edit-space").forEach((button) => {
      button.addEventListener("click", () => {
        ...
        spaceModal.querySelector("#spaceModalTitle").textContent =
          "Editar espaço";
  ...
  const renderScheduleBlocks = () => {
    scheduleBlocksList.innerHTML = blocks
      .map(
        (block) => `
    ...
    scheduleBlocksList.querySelectorAll(".edit-block").forEach((button) => {
      button.addEventListener("click", () => {
        ...
        blockModal.querySelector("#blockModalTitle").textContent =
          "Editar bloqueio";
  ...
  const renderReminderList = () => {
    ...
    reminderList.querySelectorAll(".edit-reminder").forEach((button) => {
      button.addEventListener("click", () => {
        ...
        reminderModal.querySelector("#reminderModalTitle").textContent =
          "Editar lembrete";
